...
abstract class AbstractHotbar {
    abstract public function getItems(): array;

    protected function createHotbarItem(string $tagName, string $customName, array $lore, Item $item): Item {
        $item->setCustomName($customName);
        $item->setLore($lore);
        $item->getNamedTag()->setString("hotbarItem", $tagName);
        return $item;
    }
}